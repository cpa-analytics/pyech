...
cat_arrays = [[3209725.0, 308206.0], [0.08761002], [78600.0, 81014.0, 1626098.0, 1732219.0]]
noncat_arrays = [[82965.39028371], [3926., 3902., 4321.5, 3526.], [8.05198985e+10, 1.93731241e+09]]
...
def test_noncat(variable, aggfunc, by, result, household_level):
    output = survey.summarize(variable, aggfunc=aggfunc, by=by, household_level=household_level)
